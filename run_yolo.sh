...
PYTORCH_YOLO_EO_DRONE_CONFIG="${ROS_WS}/install/sentinel_bringup/share/sentinel_bringup/config/ultralytics_yolo_eo_drone.yaml"
PYTORCH_YOLO_EO_PERSON_CONFIG="${ROS_WS}/install/sentinel_bringup/share/sentinel_bringup/config/ultralytics_yolo_eo_person.yaml"
...
if [ ! -f "${PYTORCH_YOLO_EO_DRONE_CONFIG}" ] || [ ! -f "${PYTORCH_YOLO_EO_PERSON_CONFIG}" ]; then
