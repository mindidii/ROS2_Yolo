...
from yolo_detector_pkg.common.class_names import get_class_name
from yolo_detector_pkg.common.class_names import get_num_classes
from yolo_detector_pkg.common.models import Detection
from yolo_detector_pkg.detection.postprocess import decode_yolo_output
from yolo_detector_pkg.detection.preprocess import preprocess_image
...
class YoloDetector:
    ...
    def load(self):
        ...
        if model_ext == '.engine':
            from yolo_detector_pkg.detection.tensorrt_infer import TensorRtObjectDetector

            self.backend = TensorRtObjectDetector(self.model_path)
            return

        if model_ext == '.onnx':
            from yolo_detector_pkg.detection.onnx_infer import OnnxObjectDetector
    ...
    def detect(self, cv_image) -> list[Detection]:
        ...
        input_tensor, transform = preprocess_image(
            cv_image,
